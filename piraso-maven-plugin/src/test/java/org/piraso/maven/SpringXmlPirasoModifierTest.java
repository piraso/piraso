...
/**
 * Test for {@link SpringXmlPirasoModifier} class.
 */
public class SpringXmlPirasoModifierTest {
    @Test
    public void testExecute() throws Exception {
        SpringXmlPirasoModifier modifier = new SpringXmlPirasoModifier();
        ...
        modifier.setClassReplacements(Arrays.asList(
                new ClassReplacement("com.test.core.spring.remoting.HttpInvokerRequestExecutorWithTimeout", "com.alvin.testing")
        ));
