 ...
 * @version $Id: WebappStructure.java 1390192 2012-09-25 22:16:06Z dennisl $
 */
public class WebappStructure
{
     ...
     * @throws java.io.IOException if the callback invocation throws an IOException
     */
    ...
    /**
     * Returns the owners. Note that this the returned {@link java.util.Set} may be
    ...
    public interface RegistrationCallback
    {
         ...
         * @throws java.io.IOException if an error occurred while handling this event
         */
