 ...
 * @version $Id: WebappStructureSerializer.java 985593 2010-08-14 22:12:09Z dennisl $
 */
public class WebappStructureSerializer
{
     ...
     * @throws java.io.IOException if an error occurred while reading the structure
     */
     ...
     * @throws java.io.IOException if an error occurred while saving the webapp structure
     */
