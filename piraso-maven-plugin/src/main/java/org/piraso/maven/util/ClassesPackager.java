...
import org.piraso.maven.packaging.AbstractWarPackagingTask;
...
public class ClassesPackager
{
     ...
     * @throws org.apache.maven.plugin.MojoExecutionException if an error occurred while creating the archive
     */
