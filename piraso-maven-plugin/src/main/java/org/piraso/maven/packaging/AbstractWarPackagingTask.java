...
import org.piraso.maven.AbstractWarMojo;
import org.piraso.maven.util.MappingUtils;
import org.piraso.maven.util.PathSet;
import org.piraso.maven.util.WebappStructure;
    ...
    implements WarPackagingTask
{
     ...
     * @throws java.io.IOException if an error occurred while copying
     */
     ...
     * @throws org.apache.maven.plugin.MojoExecutionException if an error occurred while unpacking the file
     */
