...
import org.piraso.maven.Overlay;
import org.piraso.maven.util.PathSet;
    ...
    extends AbstractWarPackagingTask
{
     ...
     * @throws org.apache.maven.plugin.MojoExecutionException if a resource could not be copied
     */
     ...
     *
     * @param context the packaging context
     * @throws org.apache.maven.plugin.MojoExecutionException if the sources could not be copied
     */
     ...
     *
     * @param context the packaging context
     * @throws org.apache.maven.plugin.MojoExecutionException if the artifacts could not be packaged
     */
     ...
     *
     * @param context the packaging context
     * @throws org.apache.maven.plugin.MojoExecutionException if the classes could not be packaged
     */
     ...
     * @throws org.apache.maven.plugin.MojoFailureException   if the web.xml is specified but does not exist
     * @throws org.apache.maven.plugin.MojoExecutionException if an error occurred while copying the descriptors
     */
     ...
     * @throws java.io.IOException            if an error occurred while copying the resources
     * @throws org.apache.maven.plugin.MojoExecutionException if an error occurred while retrieving the filter properties
     */
